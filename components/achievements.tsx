...
type AchievementId = "cursor" | "geoai" | "algo" | "meta";
...
export function Achievements() {
  ...
  const active = items.find((item) => item.id === open) ?? null;
                ...
                {item.certificate ? (
                  <div className="w-full overflow-hidden border border-line/80 lg:w-auto">
                    ...
                    <img
                      ...
                      alt=""
                      className="aspect-[16/10] w-full object-cover object-top transition-transform duration-500 ease-out group-hover:scale-[1.03] lg:w-[260px] xl:w-[328px]"
                    />
                  </div>
                ) : null}
              </div>
