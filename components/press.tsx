          ...
          {press.map((item) => (
            <li key={item.href}>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex w-full items-center gap-4 border border-line p-5 transition-colors duration-150 hover:border-signal sm:gap-6"
              >
                ...
                <span className="shrink-0 font-mono text-data text-ink-muted">{item.date}</span>
              </a>
            </li>
          ))}
        </ul>
